...
def on_text_message(data):
    ...
    if content[0] == 'a':
        ...
        response = requests.get(f'http://api.brainshop.ai/get?bid=167307&key=ewFHnwW1PUBBIbWG&uid=1&msg={text}')
        message = translator.translate(response.json()['cnt'], lang_src='en', lang_tgt='en')  # lang_tgt - your language
